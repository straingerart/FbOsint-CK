...
def baliho():
	try:
	    ...
	    print (R+ '.Oo   .;;.'  'cyber kith' ).center(53)
	    print   ' '
            print (W+ 'F B O S I N T').center(48)
	    print (W + '  [' + G +'Facebook Open-source intelligence (OSINT)'+ W + ']')
	    print (W + '    GITHUB.COM/STRAINGERART -   CYBERKITH         ')
            print ' '
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Straingerart
    Name       Facebook Open-source intelligence (OSINT)
    Version    v1.1
    Date       1-7-2021
    Contact    https://www.youtube.com/c/cyberkith
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'goks3' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'goks3' + W +'/' + R +'Bot ' + W + '>> ')
